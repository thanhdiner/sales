...
const faqData = [
  ...
  },
  {
    ...
    answer: 'Thời hạn đổi trả tùy từng sản phẩm. Thông thường từ 7–30 ngày kể từ khi nhận hàng. Xem chi tiết tại trang Chính sách đổi trả.',
  ...
  },
  {
    ...
    answer: 'Gọi hotline hoặc nhắn Zalo 0823387108. Fanpage, email cũng luôn sẵn sàng hỗ trợ bạn.',
    icon: <CustomerServiceOutlined className="text-red-400" />
  }
]

const FAQPage = () => (
  <div className="max-w-2xl mx-auto py-10 px-4 bg-blue-50 rounded-2xl shadow-md">
