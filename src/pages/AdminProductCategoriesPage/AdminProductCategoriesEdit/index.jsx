...
function AdminProductCategoriesEdit() {
  ...
  return (
    <Form className="admin-product-categories-form" form={form} layout="vertical" onFinish={handleSubmit}>
      <Row gutter={[16, 0]}>
        <Col xs={24} md={12}>
      ...
      <Form.Item className="admin-product-categories-form-actions-item">
        <div className="admin-product-categories-form-actions">
          <Button className={secondaryButtonClass} onClick={() => navigate(pathNavigate)} disabled={loading}>
            {t('form.cancel')}
          </Button>
