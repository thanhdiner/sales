            ...
            <aside className="admin-blog-panel admin-blog-form-sidebar">
              ...
              <div className="admin-blog-form-section">
                <div className="admin-blog-form-grid">
                  ...
                  <Select
                    size="large"
                    getPopupContainer={getAdminBlogPopupContainer}
                    options={[
                ...
                <Form.Item label={t('form.publishedAt')} name="publishedAt">
                  <DatePicker showTime size="large" className="admin-blog-date-picker" getPopupContainer={getAdminBlogPopupContainer} />
                </Form.Item>
                ...
                <Form.Item label={t('form.tags')} name="tags">
                  <Select mode="tags" tokenSeparators={[',']} placeholder={t('form.tagsPlaceholder')} getPopupContainer={getAdminBlogPopupContainer} />
                </Form.Item>
                ...
                <Form.Item label={t('form.translations.tags')} name={['translations', 'en', 'tags']}>
                  <Select mode="tags" tokenSeparators={[',']} placeholder={t('form.translations.tagsPlaceholder')} getPopupContainer={getAdminBlogPopupContainer} />
                </Form.Item>
