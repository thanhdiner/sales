...
import { getAdminBlogPost, updateAdminBlogPost, uploadAdminBlogMedia } from '@/services/adminBlogService'
...
export default function AdminBlogEdit() {
  ...
  const handleSubmit = async values => {
    ...
    try {
      ...
      await updateAdminBlogPost(id, buildBlogFormData(formValues, { fileList, oldThumbnail, thumbnailToDelete }))
