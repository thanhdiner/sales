...
const readonlyInputClassName = '!border-[var(--admin-border)] !bg-[var(--admin-surface-2)] !text-[var(--admin-text-muted)] !opacity-100'

export default function ProfileFields({ loading, roleLabel, statusLabel, lastLoginLabel, t }) {
  return (
    <Row gutter={16}>
      <Col span={12}>
        <Form.Item
