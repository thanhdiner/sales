...
export default function ReviewsFilters({ search, total, onSearchChange }) {
  const { t } = useTranslation('adminReviews')

  return (
    <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
      <div className="relative flex-1">
        <Search className="absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 text-[var(--admin-text-subtle)]" strokeWidth={1.8} />
