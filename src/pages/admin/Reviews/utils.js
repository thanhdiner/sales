export const REVIEWS_PAGE_LIMIT = 15
export const REVIEWS_STATS_LIMIT = 10000
export const REVIEWS_SEARCH_DEBOUNCE_MS = 400
...
export const getReviewsQueryParams = ({ page, limit, rating, search } = {}) => {
...
export const normalizeReviewReplyPayload = values => ({
  ...
  translations: {
    en: {
      content: typeof values?.translations?.en?.content === 'string' ? values.translations.en.content.trim() : ''
    }
  }
})
