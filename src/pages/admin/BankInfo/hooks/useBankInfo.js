...
import {
  ...
  getBankInfos,
  updateBankInfo
} from '@/services/admin/system/bankInfo'
import {
  BANK_INFO_FORM_INITIAL_VALUES,
  buildBankInfoFormData,
  getBankInfoQrFileList,
  getBankInfoTranslationValues
} from '../utils'

export default function useBankInfo({ t = key => key } = {}) {
  ...
  const handleCreate = () => {
    ...
    setQrToDelete('')
    setIsRemoveQR(false)
    form.setFieldsValue(BANK_INFO_FORM_INITIAL_VALUES)
    setOpen(true)
  }
