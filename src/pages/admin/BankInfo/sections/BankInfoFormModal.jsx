...
export default function BankInfoFormModal({
  t,
  open,
  editing,
  form,
  ...
  return (
    ...
    >
      <div ref={contentRef}>
        <Form form={form} layout="vertical" initialValues={BANK_INFO_FORM_INITIAL_VALUES} className="admin-bank-info-modal__form">
