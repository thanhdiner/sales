      ...
      >
        <FormSection title={t('form.sections.basic')}>
          <Row gutter={[16, 0]}>
            ...
            <Col xs={24} md={4}>
              <Form.Item name="isActive" label={<span className={labelClass}>{t('form.status')}</span>} valuePropName="checked">
            ...
            <Row gutter={[16, 0]}>
              <Col xs={24} md={12}>
                <Form.Item
                  ...
                  label={<span className={labelClass}>{t('form.translations.title')}</span>}
                >
              ...
              <Col xs={24} md={12}>
                <Form.Item
                  ...
                  label={<span className={labelClass}>{t('form.translations.description')}</span>}
                >
            ...
            <Col xs={24} md={8}>
              ...
              >
                <InputNumber
                  ...
                  formatter={value =>
                    discountType === 'percent' ? formatPromoCodePercentInput(value) : formatPromoCodeNumberInput(value, language)
                  }
