...
export default function PermissionGroupsHeader({ canCreateGroup, onCreateGroup }) {
  ...
  return (
    <div className="admin-permission-groups-header">
      <div className="admin-permission-groups-header__content">
        ...
        <Text className="admin-permission-groups-header__description">{t('page.description')}</Text>
      </div>
