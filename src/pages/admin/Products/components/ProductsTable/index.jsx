...
import { deleteProduct } from '@/services/admin/commerce/product'
...
const getProductCategoryTitle = (product, t, language) => getLocalizedProductCategoryTitle(product, language, t('table.uncategorized'))
