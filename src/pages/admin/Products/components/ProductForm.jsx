      ...
      >
        <div className={`${prefix}__card`}>
          ...
          <Row gutter={16}>
            <Col xs={24} lg={12}>
              ...
              <Form.Item name="deliveryInstructions" label={aiLabel('form.deliveryInstructions', 'deliveryInstructions')}>
                <Input.TextArea className={`${prefix}__textarea`} placeholder={t('form.deliveryInstructionsPlaceholder')} rows={3} />
              </Form.Item>
            ...
            <Col xs={24} lg={12}>
              ...
              <Form.Item name="timeRange" label={label('form.promotionTime')}>
                <RangePicker className={`${prefix}__picker`} format="YYYY-MM-DD" popupClassName={`${prefix}-picker-popup`} showTime />
              </Form.Item>
          ...
          <Row gutter={16}>
            ...
            <Col span={24}>
              <RichTextField editorClassName={`${prefix}__editor`} form={form} label={aiLabel('form.content', 'content')} name="content" />
            </Col>
