...
import { FeatureListField, RichTextField } from '@/components/admin/form'
  ...
  return (
    <div className={`${classNamePrefix}__translation-section`}>
      ...
      <Row gutter={16}>
        ...
        <Col xs={24} lg={12}>
          <Form.Item
            name={['translations', 'en', 'deliveryInstructions']}
            label={aiLabel('form.translations.deliveryInstructions', 'translations.en.deliveryInstructions')}
          >
            <Input.TextArea
