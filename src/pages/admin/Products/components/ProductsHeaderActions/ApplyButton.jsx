...
import { changePositionManyProducts, changeStatusManyProducts, deleteManyProducts } from '@/services/admin/commerce/product'
...
function ApplyButton({
  ...
  return (
    <Button
      type="primary"
      className="admin-products-btn admin-products-btn--apply"
