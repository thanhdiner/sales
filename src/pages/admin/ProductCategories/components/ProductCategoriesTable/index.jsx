...
import AdminFieldUserInfo from '@/components/admin/FieldUserInfo'
...
function ProductCategoryMobileCard({ record, selected, onSelectChange, setEditedPositions, setProductCategories, handleDelete }) {
...
function ProductCategoriesTable({
  ...
  const columns = [
    ...
    },
    {
      ...
      width: 260,
      render: (_, record) => (
        <FieldTitle categoryName={getLocalizedProductCategoryTitle(record, language, record.title || fallbackText)} record={record} />
      )
    },
    {
