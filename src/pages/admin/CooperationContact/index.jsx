...
} from '@/services/admin/content/cooperationContact'
...
function CooperationContact() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const response = await updateCooperationContactContent({
        ...payload,
        translations: {
...
export default CooperationContact
