...
function AdminComingSoonPage() {
  ...
  return (
    <AdminLocalizedContentPage
      ...
      getContent={currentConfig => getAdminComingSoonContent(currentConfig.routeKey)}
      updateContent={(payload, currentConfig) => updateAdminComingSoonContent(currentConfig.routeKey, payload)}
