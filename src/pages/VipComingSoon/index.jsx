...
function VipHeroSection({ hero, heroImage }) {
  return (
...
function VipQuickBenefitsSection({ items = [] }) {
...
function VipPricingSection({ section, plans = [], onSelectPlan }) {
...
function VipComparisonSection({ section, rows = [], plans = [], language }) {
...
function VipBenefitsSection({ section, items = [] }) {
  if (!items.length) return null
...
function VipFaqSection({ section, items = [], openIndex, onToggle }) {
  if (!items.length) return null
  ...
  return (
    <main className="vip-page" aria-busy={loading}>
      ...
      <div className="vip-page__inner">
        ...
        <VipHeroSection hero={content.hero} heroImage={heroImage} />
        <VipQuickBenefitsSection items={content.quickBenefits} />
        <VipPricingSection section={content.plansSection} plans={content.plans} onSelectPlan={handleSelectPlan} />
        <VipComparisonSection section={content.comparisonSection} rows={content.comparisonRows} plans={content.plans} language={language} />
        <VipBenefitsSection section={content.benefitsSection} items={content.benefits} />
        <VipFaqSection section={content.faqSection} items={content.faqs} openIndex={openFaqIndex} onToggle={toggleFaq} />
        <VipCtaSection cta={content.cta} />
      </div>
    </main>
  )
}
