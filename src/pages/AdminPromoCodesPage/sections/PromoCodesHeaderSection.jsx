...
export default function PromoCodesHeaderSection({ loading, onCreate, onExport, onRefresh }) {
    ...
    <section className="admin-promo-header rounded-xl border border-[var(--admin-border)] bg-[var(--admin-surface)] p-4 shadow-[var(--admin-shadow)] sm:p-5">
      <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
        <div className="min-w-0">
          ...
          <p className="mt-2 max-w-2xl text-sm leading-6 text-[var(--admin-text-muted)] sm:text-base">
            {t('page.subtitle')}
          </p>
        </div>
