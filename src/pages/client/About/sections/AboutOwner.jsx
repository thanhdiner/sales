  ...
  return (
    ...
    >
      <div className="relative mb-4 flex h-[92px] w-[92px] items-center justify-center">
        <svg viewBox="0 0 100 100" className="about-page__stat-ring absolute inset-0 h-full w-full" aria-hidden="true">
          <circle
            cx="50"
            cy="50"
            r="31"
        ...
        <div
          className="about-page__ring-icon relative z-10 flex h-[48px] w-[48px] items-center justify-center text-[#1f67c7]"
      ...
      <div className="about-page__stat-label text-[15px] font-medium text-[#3e68a0]">{label}</div>
    </motion.div>
  )
}

const AboutOwner = ({ content, viewport = { once: true, amount: 0.2 } }) => {
  ...
  return (
    <section className="px-4 py-10 md:px-6 md:py-14">
      <div className="mx-auto max-w-7xl">
        <motion.div
          className="about-page__surface overflow-hidden border border-[#eeeeee] bg-white shadow-[0_8px_24px_rgba(0,0,0,0.04)]"
        ...
        >
          <div className="grid grid-cols-1 lg:grid-cols-[1.3fr_0.9fr]">
            <div className="about-page__surface-soft bg-white px-6 py-8 md:px-10 md:py-12 lg:px-12">
              ...
              <div className="about-page__surface mb-14 border border-[#efefef] bg-white shadow-[0_3px_14px_rgba(0,0,0,0.04)]">
                <div className="grid min-h-[220px] grid-cols-[8px_150px_1fr] md:grid-cols-[10px_180px_1fr]">
                  <div className="about-page__owner-rail bg-[#1f67c7]" />

                  <div className="flex items-center justify-center px-6">
                    <div className="about-page__ring-icon flex h-20 w-20 items-center justify-center rounded-full text-[#1f67c7] md:h-24 md:w-24">
                  ...
                  <div className="flex items-center px-6 py-8 md:px-8">
                    <div className="about-page__owner-copy max-w-[420px] space-y-4 text-[15px] leading-8 text-[#6f6f6f] md:text-[16px]">
                      {Array.isArray(paragraphs) && paragraphs.map((paragraph, index) => <p key={`${paragraph}-${index}`}>{paragraph}</p>)}
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="about-page__owner-media relative min-h-[420px] bg-white lg:min-h-full">
              {!isOwnerImageLoaded ? (
                <div className="about-page__skeleton absolute inset-0 animate-pulse bg-gradient-to-br from-slate-200 via-slate-100 to-slate-200 dark:from-slate-700 dark:via-slate-800 dark:to-slate-700" />
              ) : null}
