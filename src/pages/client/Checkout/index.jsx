...
import { buildCheckoutFormDefaults } from '@/lib/checkout/checkoutProfile'
import { clearCheckoutDraft, normalizeCheckoutStep, readCheckoutDraft, writeCheckoutDraft } from '@/lib/checkout/checkoutDraft'
import {
  hasAnyStructuredVietnamAddressInput,
  hasCompleteStructuredVietnamAddress,
  inferVietnamAddressFromText,
  normalizeVietnamAddress
} from '@/lib/address/vietnamAddress'
import useVietnamAddress from '@/hooks/shared/useVietnamAddress'
