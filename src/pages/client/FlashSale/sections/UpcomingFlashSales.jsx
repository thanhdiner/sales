...
import { formatDateTime, getTimeUntilStart } from '../utils/flashSaleUtils'
import StatusBadge from '../components/StatusBadge'
import TimeBox from '../components/TimeBox'

export default function UpcomingFlashSales({ currentTime, t, upcomingFlashSales }) {
  ...
  return (
    ...
    >
      ...
      <motion.div className="grid grid-cols-1 gap-4 md:grid-cols-2" variants={FLASH_SALE_STAGGER_VARIANTS}>
        {upcomingFlashSales.map((sale, saleIndex) => {
          ...
          return (
            <motion.article
              ...
              variants={FLASH_SALE_CARD_VARIANTS}
