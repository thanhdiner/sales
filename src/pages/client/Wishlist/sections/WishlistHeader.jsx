import WishlistAddAllButton from '../components/WishlistAddAllButton'

function WishlistHeader({ addingAllToCart, canAddAll, inStockCount, onAddAllToCart, t, totalItems }) {
  return (
