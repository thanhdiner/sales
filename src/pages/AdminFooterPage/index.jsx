...
import { getAdminFooterContent, updateAdminFooterContent } from '@/services/footerContentService'
import {
  DEFAULT_FOOTER_CONTENT,
  DEFAULT_FOOTER_TRANSLATIONS,
  alignFooterTranslation,
  normalizeFooterContent
} from '@/Layout/LayoutDefault/Footer/footerContent'
import './AdminFooterPage.scss'
...
function AdminFooterPage() {
  ...
  const fetchContent = useCallback(async () => {
    ...
    try {
      const response = await getAdminFooterContent()
  ...
  const handleSubmit = async () => {
    ...
    try {
      const response = await updateAdminFooterContent({
        content,
        translations: {
          en: englishTranslation
        }
